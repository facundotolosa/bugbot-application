...
| [`specs/09-evals-console-reporter/`](specs/09-evals-console-reporter/) | Vitest-style `npm run eval` console: quiet agent stream, suite/case tree, spinner, concise failure lines. [spec.md](specs/09-evals-console-reporter/spec.md) | Pending |
