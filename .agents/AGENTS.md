...
| [`specs/05-pipeline-observability/`](specs/05-pipeline-observability/) | Pipeline observability: wrapper logger, orchestrator progress blocks, SDK stream prefix, run artifacts for CI/local. | Pending |
