...
| [`specs/07-review-progress-ux/`](specs/07-review-progress-ux/) | Mandatory TodoWrite (local), English-only concise stdout, ephemeral temp IPC files (no `work/` clutter). [spec.md](specs/07-review-progress-ux/spec.md) · [plan.md](specs/07-review-progress-ux/plan.md) | Implemented (pending `/validate`) |
