...
export const CurrencyBadge: FC<CurrencyBadgeProps> = ({ title, subtitle, amount, variant = "default" }) => (
  <section className={`ledger-currencybadge ledger-currencybadge--${variant}`}>
    <header>
      <h2>{title}</h2>
